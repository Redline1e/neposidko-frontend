          ...
          <SidebarGroup className="space-y-2">
            <Button variant="outline" className="w-full">
              <Link href="/admin" className="block w-full">
                <p className={cn("text-neutral-900", currentPath === "/admin" && "font-bold")}>
                  Головна(Пошук)
                </p>
              </Link>
            </Button>
            <Button variant="outline" className="w-full">
              <Link href="/admin/addproduct" className="block w-full">
                <p className={cn("text-neutral-900", currentPath === "/admin/addproduct" && "font-bold")}>
                  Додати товар
                </p>
              </Link>
            </Button>
            <Button variant="outline" className="w-full">
              <Link href="/admin/addcategory" className="block w-full">
                <p className={cn("text-neutral-900", currentPath === "/admin/addcategory" && "font-bold")}>
                  Додати категорію
                </p>
              </Link>
            </Button>
            <Button variant="outline" className="w-full">
              <Link href="/admin/addbrand" className="block w-full">
                <p className={cn("text-neutral-900", currentPath === "/admin/addbrand" && "font-bold")}>
                  Додати бренд
                </p>
              </Link>
            </Button>
            <Button variant="outline" className="w-full">
              <Link href="/admin/statistics" className="block w-full">
                <p className={cn("text-neutral-900", currentPath === "/admin/statistics" && "font-bold")}>
