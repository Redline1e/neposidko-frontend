...
import { useAuth, fetchUserById } from "@/lib/user-service";
...
export const CommentsSection: React.FC<CommentsSectionProps> = ({
  ...
  // Створюємо мапу для збереження імен користувачів за їх id
  ...
  // Після завантаження відгуків отримуємо імена користувачів за їх id
  useEffect(() => {
